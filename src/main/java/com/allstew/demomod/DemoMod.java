...
public class DemoMod {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(
        Registries.CREATIVE_MODE_TAB, Constants.MOD_ID);
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register(
        "example_tab", () -> CreativeModeTab.builder().title(
                Component.translatable("itemGroup.demo_mod")) //The language key for the title of your CreativeModeTab
    ...
    public DemoMod(IEventBus modEventBus, ModContainer modContainer) {
